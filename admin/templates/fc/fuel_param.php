...
<td align="center" colspan="8"><a id="dialog" class="jqModal" href="<?php echo SITE_URL?>/admin/action.php/Fuelcal/addparam"><input type="button" Value="Set Parameters"></a></td>
</table>
</form>
